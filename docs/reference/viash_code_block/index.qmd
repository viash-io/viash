...
# to unset a default cpu value, pass an empty string
output/my_executable ---cpus ""
```
...
# to unset a default memory value, pass an empty string
output/my_executable ---memory ""
```
