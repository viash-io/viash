...
Viash helps you build software components from small R/Python/Bash scripts. By providing
some meta-data regarding the functionality provided by the component and 
...
We are currently working on increasing reproducability with viash by tying 
the executable to a particular Docker container.
