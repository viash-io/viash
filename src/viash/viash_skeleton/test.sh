...
viash test my_src/test/testbash/config.vsh.yaml --engine native
...
viash test src/test/testpy/config.vsh.yaml --engine native
...
viash test src/test/testr/config.vsh.yaml --engine native
