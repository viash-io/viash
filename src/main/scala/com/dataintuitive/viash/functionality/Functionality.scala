...
case class Functionality(
  ...
  def mainCode: Option[String] = {
    if (platform == NativePlatform) {
      None
    } else if (mainFile.code.isDefined) {
      mainFile.code
    } else {
      val mainPath = Paths.get(rootDir.getPath(), mainFile.path.get).toFile()
        ...
        case pl => {
          ...
          if (startIndex >= 0 && endIndex >= 0) {
            val li =
              ...
              Array(
                pl.commentStr + " The following code has been auto-generated by Viash.",
