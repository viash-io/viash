...
@removed("Nextflow platform with `variant: legacy` was removed", "0.6.0", "0.7.0")
case class NextflowLegacyPlatform(
  ...
  @removed("Undocumented & stale value", "0.6.3", "0.7.0")
  private val executor: Option[String] = None
  @removed("nextflow platform: attribute 'version' was removed", "0.4.0", "0.7.0")
