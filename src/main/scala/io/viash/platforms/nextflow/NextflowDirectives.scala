...
case class NextflowDirectives(
  ...
  module: OneOrMore[String] = Zero,
  penv: Option[String] = None,
  pod: OneOrMore[Map[String, String]] = Zero,
  publishDir: OneOrMore[Either[String, Map[String, String]]] = Zero, // TODO: need to implement publishdir class?
  queue: OneOrMore[String] = Zero,
